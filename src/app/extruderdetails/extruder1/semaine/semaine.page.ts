...
export class SemainePage implements OnInit {
  ...
  pdfDownload() {
    const docDef = {
      ...
      {text: 'Wöchentliche Wartung von Extruder 1 (EX1)',fontSize: 25,margin: [0, 45, 0, 0], bold: true, Style: 'subheader', alignment: 'center', },
      ...
      {text: 'Datum :',margin: [0, 45, 0, 0], fontSize:18},
          ...
          {text: 'Wasser Filter :',margin: [0, 45, 0, 0], fontSize:18},
              {text: this.WasserFilter,margin: [150, -20, 0, 0], fontSize:16,bold:true},
