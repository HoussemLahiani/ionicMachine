  ...
  pdfDownload() {
    const docDef = {
      ...
      content: [
        ...
        {text: 'Monatliche Wartung von Extruder 1 (EX1)',fontSize: 25,margin: [0, 45, 0, 0], bold: true, Style: 'subheader', alignment: 'center', },
        ...
        {text: 'Datum :',margin: [0, 45, 0, 0], fontSize:18},
            ...
            {text: 'Spritzkopfdüse :',margin: [0, 45, 0, 0], fontSize:18},
                {text: 'Gereinigt',margin: [150, -20, 0, 0], fontSize:16,bold:true},
               
            {text: 'Kupferpaste Gewinde :',margin: [0, 45, 0, 0], fontSize:18},
                {text: 'Angewendet',margin: [200, -20, 0, 0], fontSize:16,bold:true},
