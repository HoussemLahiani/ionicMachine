...
export class JourPage implements OnInit {
  ...
  backpage(){this.route.navigate(['/extruderdetails/extruder1'])}
  pdfDownload() {const docDef = {pageSize: 'A4' ,
                                pageOrientation: 'portrait',
   
                                content: [{text: [{text: 'Clina', style: 'Header',bold:true,},'- BESSER HEIZEN UND KÜHLEN',],style: 'subheader',margin: [0, 0,0,0]},
        ...
        {text: 'Tägliche Wartung von Extruder 1 (EX1)',fontSize: 25,margin: [0, 45, 0, 0], bold: true, Style: 'subheader', alignment: 'center', },
        ...
        {text: 'Schwamm :',margin: [0, 45, 0, 0], fontSize:18},
        {text: this.Schwamm,margin: [150, -20, 0, 0], fontSize:16,bold:true},
        {text: 'Gummi :',margin: [0, 45, 0, 0], fontSize:18},
        {text: this.Gummi,margin: [150, -20, 0, 0], fontSize:16,bold:true},
        {text: 'Extrudat Filter :',margin: [0, 45, 0, 0], fontSize:18},
        {text: this.ExtrudatFilter,margin: [150, -20, 0, 0], fontSize:16,bold:true},
        {text: 'Granulat ansaugfilter :',margin: [0, 45, 0, 0], fontSize:18},
        {text: this.Granulatansaugfiltern,margin: [200, -20, 0, 0], fontSize:16,bold:true},
        {text: 'Düse :',margin: [0, 45, 0, 0], fontSize:18},
        {text: this.Duse,margin: [150, -20, 0, 0], fontSize:16,bold:true},],
                styles: {
                header: {
                fontSize: 18,
                bold: true,
    ...
    this.pdfOjb.download(Date(),'jour');
