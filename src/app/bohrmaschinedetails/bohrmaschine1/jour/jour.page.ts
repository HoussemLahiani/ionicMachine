...
export class JourPage implements OnInit {
  ...
  Duse='';
  constructor( private route : Router,public file: File,public fileOpener: FileOpener,public alertCtrl: AlertController ) { }
  ...
  pdfDownload() {
    const docDef = {
      ...
      content: [
        ...
        {text: 'Tägliche Wartung von Bohrmaschine 1 (BM1)',fontSize: 25,margin: [0, 45, 0, 0], bold: true, Style: 'subheader', alignment: 'center', },
        ...
        {text: 'Datum :',margin: [0, 45, 0, 0], fontSize:18},
            ...
            {text: 'Löcher kontrolliert ',margin: [0, 45, 0, 0], fontSize:18},
                {text: this.Schwamm,margin: [150, -20, 0, 0], fontSize:16,bold:true},
               
            {text: 'Bohrer und Stempel gereinigt ',margin: [0, 45, 0, 0], fontSize:18},
    ...
    this.pdfOjb= pdfMake.createPdf(docDef).getBlob(buffer => {
