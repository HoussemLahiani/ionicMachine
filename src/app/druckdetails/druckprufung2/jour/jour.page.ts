  ...
  pdfDownload() {
    const docDef = {
      ...
      content: [
        ...
        {text: 'Tägliche Wartung von Druckbecken 2 (DB2)',fontSize: 25,margin: [0, 45, 0, 0], bold: true, Style: 'subheader', alignment: 'center', },
        ...
        {text: 'Datum :',margin: [0, 45, 0, 0], fontSize:18},
            ...
            {text: 'Anschlüsse :',margin: [0, 45, 0, 0], fontSize:18},
                {text: 'Eingefettet',margin: [150, -20, 0, 0], fontSize:16,bold:true},
               
            {text: 'Becken :',margin: [0, 45, 0, 0], fontSize:18},
